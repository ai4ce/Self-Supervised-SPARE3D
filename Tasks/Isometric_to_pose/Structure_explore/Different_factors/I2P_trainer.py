...
parser.add_argument('--new_model', action='store_true', default=False, help='True is new model, False is old model')
parser.add_argument('--nd', action='store_true', default=False, help='If True, no Dropout layer')
parser.add_argument('--na', action='store_true', default=False, help='If True, no Adaptavg layer')
parser.add_argument('--share_weights', action='store_true', default=False, help='If True, share weights')
parser.add_argument('--pretrained', action='store_true', default=False, help='If True, load pretrained dict')
parser.add_argument('--fc', default='1', help='|1| means 1 layer, |3| means 3+1 layer')
...
task_4_model=I2P(opt.model_type,opt.new_model,opt.nd,opt.na,opt.share_weights,opt.pretrained,opt.fc).to(opt.device)
...
file.write('New_model\t{}\nnd\t\t{}\nna\t\t{}\nshare_weights\t{}\npretrained\t{}\nfc\t\t{}\n\n'.format(opt.new_model,opt.nd,opt.na,opt.share_weights,opt.pretrained,opt.fc))
bad_shape=[]
