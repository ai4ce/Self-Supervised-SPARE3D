...
class Model2SVG(object):
    ...
    def __init__(self, tol=0.03, unit="mm", width=800, height=600, margin_left=10, margin_top=10,
        ...
        uf,df=gp_Dir(0,-1,1),gp_Dir(0,-1,-1)
        ur,dr=gp_Dir(1,0,1),gp_Dir(1,0,-1)
        ub,db=gp_Dir(0,1,1),gp_Dir(0,1,-1)
        ul,dl=gp_Dir(-1,0,1),gp_Dir(-1,0,-1)

        m1,m2,m3,m4=gp_Dir(-1,-1,0),gp_Dir(1,-1,0),gp_Dir(1,1,0),gp_Dir(-1,1,0)
