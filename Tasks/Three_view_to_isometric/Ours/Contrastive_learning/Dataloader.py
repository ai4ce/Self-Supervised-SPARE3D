...
class ThreeV2I_data(Dataset):
    ...
    def __getitem__(self, idx):   
        ...
        Front_imgr=self.convert_input(input_dic,"/*_fright.png")
        Right_imgr=self.convert_input(input_dic,"/*_rright.png")
        Top_imgr=self.convert_input(input_dic,"/*_tright.png")
        Isometricr=self.convert_input(input_dic,"/isometric_right.png")
        Label = torch.tensor(([1, 0, 0, 1]))
        return Front_imgl,Right_imgl,Top_imgl,Isometricl,Front_imgr,Right_imgr,Top_imgr,Isometricr,Label
    def __len__(self):
        return len(self.dic)
